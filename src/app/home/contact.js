  ...
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="group relative overflow-hidden rounded-2xl shadow-lg transform transition-all duration-500 hover:-translate-y-2">
            ...
            <div className="relative p-8 z-10 h-full flex flex-col">
              ...
              <a 
                href="mailto:syedmughanibukhari@gmail.com" 
                className="mt-auto text-white font-medium flex items-center"
              >
                syedmughanibukhari@gmail.com
    ...
    <div className="relative z-10 p-10 text-center backdrop-blur-sm">
      ...
      <div className="flex flex-wrap justify-center gap-8">
        {/* LinkedIn */}
        <a
          href="https://linkedin.com/in/syedmughanibukhari"
          target="_blank"
          rel="noopener noreferrer"
        ...
        {/* GitHub */}
        <a
          href="https://github.com/smughanibukari"
          target="_blank"
          rel="noopener noreferrer"
          className="group/icon"
          aria-label="GitHub"
      ...
      <div className="mt-12">
        <a 
          href="mailto:syedmughanibukhari@gmail.com?subject=Let's Work Together"
