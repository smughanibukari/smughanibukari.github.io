...
const ProjectsShowcase = () => {
  const projects = [
    ...
    {
      title: "Zrintel",
      description: "An intelligent platform delivering advanced data-driven insights and business intelligence solutions.",
      bgColor: "#6366F1", // Indigo
      projectUrl: "https://zrintel.com"
    },
    {
      title: "Shoq",
      description: "A modern social and discovery platform connecting people through shared interests and experiences.",
      bgColor: "#F97316", // Orange
      projectUrl: "https://shoq.pro"
    },
    {
      title: "RangeScan",
      description: "A precision range scanning platform providing real-time analytics and performance tracking.",
      bgColor: "#0EA5E9", // Sky
      projectUrl: "https://rangescan.com"
    }
  ];
